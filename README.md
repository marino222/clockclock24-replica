...
The BKA30D-R5 allows for microstepping up to 1/12 degrees per microstep, which is ideal to achieve smooth movement of the clock hands.
...
A Raspberry Pi Pico can provide up to 2A of current from the VBUS pin when powered via USB-C. Each BKA30D-R5 motor draws a maximum of 20mA as specified in the datasheet. With all motors, Picos, and the ESP32, the total consumption should theoretically be less than 2A.
